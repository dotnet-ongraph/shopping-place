    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Shopping Place Fulfillment API",
            ...
            new FulfillmentDependencyRegistrar().RegisterDependencies(services, Configuration);
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ShoppingPlace Fulfillment API v1"));
